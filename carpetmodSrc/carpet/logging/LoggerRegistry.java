...
public class LoggerRegistry
{
    ...
    public static void initLoggers(MinecraftServer server)
    {
        ...
        registerLogger("portalCaching",new Logger(server, "portalCaching", "brief", new String[]{"brief", "full", "uncaching"}, LogHandler.CHAT));
    ...
    public static boolean togglePlayerSubscription(MinecraftServer server, String playerName, String logName, LogHandler handler)
    {
        ...
        {
            String option = getLogger(logName).getDefault();
            subscribePlayer(server, playerName, logName, option, handler);
            return true;
        }
    }
